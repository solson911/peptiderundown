...
It was first approved by the FDA in 2017 as **Ozempic** (injectable) for type 2 diabetes management, followed by **Rybelsus** (oral) in 2019 for the same indication. In June 2021, the FDA approved **Wegovy**, semaglutide at a higher dose (2.4 mg weekly), specifically for chronic weight management.

### Brand Names and Key Differences

| Brand | Form | Dose | Indication | FDA Approval |
|-------|------|------|------------|--------------|
| **Ozempic** | Subcutaneous injection | 0.5 mg, 1 mg, or 2 mg weekly | Type 2 diabetes | Dec 2017 |
...
GLP-1 receptors are expressed in the hypothalamus and brainstem, regions critical for appetite regulation. Semaglutide crosses the blood-brain barrier and acts on these receptors to reduce hunger and increase satiety. Neuroimaging studies have shown that semaglutide dampens neural responses to food cues in reward-associated brain regions, reducing cravings and the hedonic drive to eat ([Friedrichsen et al., *Diabetes Obes Metab*, 2021](https://doi.org/10.1111/dom.14323)).

### 2. Delayed Gastric Emptying

Semaglutide slows the rate at which food leaves the stomach, prolonging feelings of fullness after meals. This effect is most prominent during the early weeks of treatment and appears to partially attenuate over time, though appetite suppression persists through central mechanisms.
...
### STEP 1: Semaglutide in Adults Without Diabetes
...
- **Duration:** 104 weeks
- **Results:** Mean weight loss of **15.2%** at 2 years, demonstrating durability of effect with continued treatment.
- **Reference:** [Garvey et al., *Nat Med*, 2022](https://doi.org/10.1038/s41591-022-02026-4)

### SELECT Trial: Cardiovascular Outcomes

The SELECT trial (17,604 participants with established cardiovascular disease and overweight/obesity, without diabetes) demonstrated that semaglutide 2.4 mg reduced the risk of major adverse cardiovascular events (MACE) by **20%** compared to placebo over a median follow-up of ~40 months. This was a landmark result, the first time an anti-obesity medication showed cardiovascular benefit in a dedicated outcomes trial.
...
- **Increased heart rate:** A small mean increase of 1–4 beats per minute has been observed. Clinical significance is unclear, but the SELECT trial's cardiovascular benefit is reassuring.

### Boxed Warning: Thyroid C-Cell Tumors

Semaglutide carries a boxed warning based on rodent studies showing dose-dependent thyroid C-cell tumors (medullary thyroid carcinoma). This has not been confirmed in humans, and the relevance to human physiology is debated (rodent thyroid C-cells have far greater GLP-1 receptor density). However, semaglutide is **contraindicated** in patients with a personal or family history of medullary thyroid carcinoma (MTC) or Multiple Endocrine Neoplasia syndrome type 2 (MEN 2).
...
As of early 2026, the list prices for semaglutide products in the United States are:
...
Compounded semaglutide has emerged as a dramatically cheaper alternative, often priced at **$100–$400/month** through compounding pharmacies and telehealth platforms. This market grew rapidly during the 2022–2024 Wegovy shortage period.
...
Semaglutide is FDA-approved under three brand names (Ozempic, Rybelsus, Wegovy) as described above. It is a prescription medication requiring a healthcare provider's oversight.
...
The FDA and Novo Nordisk have raised legitimate safety concerns:

- Compounded injectables carry inherent sterility and potency risks
- Several adverse events have been reported to the FDA linked to compounded semaglutide
- Dosing accuracy can vary between compounding pharmacies
- No requirement for clinical trials or bioequivalence testing
...
- Adults with **BMI ≥27** (overweight) with at least one weight-related comorbidity (hypertension, type 2 diabetes, dyslipidemia, obstructive sleep apnea)
- Adolescents aged ≥12 with BMI at the 95th percentile or greater for age and sex

### Who Should NOT Use Semaglutide

- Personal or family history of **medullary thyroid carcinoma** or **MEN 2**
- History of **pancreatitis** (relative contraindication; use with caution)
- **Pregnancy** or planned pregnancy (discontinue ≥2 months before conception due to the long half-life)
- Known hypersensitivity to semaglutide or any excipients
- Concurrent use with other GLP-1 receptor agonists
- **Type 1 diabetes** (not indicated; risk of hypoglycemia in combination with insulin, and no evidence of benefit)

### Clinical Considerations

- **History of eating disorders:** GLP-1 RAs alter appetite and food-related reward signaling. There is limited data on their effects in patients with active eating disorders. Clinical judgment is essential.
- **History of gastroparesis:** Semaglutide further delays gastric emptying and may worsen symptoms.
- **Surgical patients:** Some anesthesiologists have raised concerns about aspiration risk due to delayed gastric emptying. The American Society of Anesthesiologists has suggested holding GLP-1 RAs before elective procedures requiring anesthesia.
- **Gallbladder disease:** Increased risk of gallstones; monitor accordingly.
...
Significant weight loss from any cause (surgery, medication, diet) can result in facial volume loss ("Ozempic face" is a colloquial, not medical, term) and excess skin. These are consequences of fat loss, not unique pharmacological effects of semaglutide. The risk correlates with the amount of weight lost, age, and skin elasticity.
...
There is no absolute contraindication, but many patients report reduced alcohol tolerance and increased nausea when combining semaglutide with alcohol. Alcohol also provides empty calories that counteract weight loss goals. Moderation is advised.
