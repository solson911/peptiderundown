...
At room temperature, it's a dark blue-green powder that dissolves in water to produce an intensely blue solution. You'll know you're taking it because it turns your urine blue-green. That's normal and harmless, though it can be startling if you're not expecting it.

The compound exists in two forms in the body: the oxidized form (methylene blue, which is blue) and the reduced form (leucomethylene blue, which is colorless). It continuously cycles between these two states, which is what makes it useful as an electron carrier.
...
This is the core of what makes methylene blue interesting. Your mitochondria produce energy (ATP) through the electron transport chain (ETC), a series of protein complexes (I through V) embedded in the inner mitochondrial membrane. Electrons flow through these complexes, and the energy released is used to pump protons, creating a gradient that drives ATP synthesis.

Here's where methylene blue comes in. At low doses, it acts as an alternative electron carrier in the ETC. It can accept electrons from NADH and transfer them directly to cytochrome c (complex IV), essentially bypassing complexes I and III ([Rojas et al., 2012](https://pubmed.ncbi.nlm.nih.gov/22040698/)).
...
Multiple animal studies show that methylene blue improves memory consolidation and retention. A study by Gonzalez-Lima and Bruchey found that low-dose methylene blue administered after fear extinction training enhanced memory retention in rats ([Gonzalez-Lima & Bruchey, 2004](https://pubmed.ncbi.nlm.nih.gov/15288279/)). The proposed mechanism is that increased mitochondrial activity in memory-related brain regions supports the energy-intensive process of consolidating short-term memories into long-term ones.

A human study by Rodriguez et al. (2016) found that a single low dose of methylene blue (280 mg USP grade) increased functional MRI activity in brain regions associated with sustained attention and short-term memory, along with improved memory retrieval ([Rodriguez et al., 2016](https://pubmed.ncbi.nlm.nih.gov/26768295/)).
...
Methylene blue directly addresses this cycle. In cell culture studies, methylene blue extended the lifespan of human fibroblasts and improved mitochondrial function in cells from patients with progeria (premature aging) ([Xiong et al., 2017](https://pubmed.ncbi.nlm.nih.gov/28041895/)).

Animal studies have shown that methylene blue:

- Extends lifespan in fungi models (C. elegans data is mixed)
- Improves skin thickness and collagen content in aged mice
...
- **Malaria parasites** - it was the first synthetic antimalarial drug, and there's renewed interest in it for treating drug-resistant malaria ([Meissner et al., 2006](https://pubmed.ncbi.nlm.nih.gov/16710766/))
- **Bacteria** - both gram-positive and gram-negative, especially when activated by light (photodynamic therapy)
- **Fungi** - including Candida species
- **Viruses** - methylene blue has been used to inactivate viruses in blood products for transfusion safety
...
- 0.5-1 mg/kg taken in the morning
- Can be taken daily or a few times per week
- Some people cycle 5 days on, 2 days off
- Take with food to reduce potential GI upset

### Medical Doses

- **Methemoglobinemia:** 1-2 mg/kg IV (hospital setting only)
- **Vasoplegic syndrome:** 1-2 mg/kg IV during cardiac surgery
- **Ifosfamide neurotoxicity:** 50 mg IV every 4-6 hours

### The Hormetic Curve

At doses above 2 mg/kg, methylene blue starts acting as a pro-oxidant rather than an antioxidant. Above 5 mg/kg, toxic effects become increasingly likely. At 7+ mg/kg, you're looking at serious toxicity including hemolytic anemia, especially in people with G6PD deficiency.
...
**Industrial/chemical grade methylene blue** is manufactured for use as a dye, biological stain, or chemical reagent. It may contain significant impurities including heavy metals (arsenic, lead, mercury, chromium), other thiazine dyes, and various organic contaminants. These impurities can be toxic.
...
**Blue-green urine.** This happens to everyone. It's the most visible sign that you've taken methylene blue. Your urine may also have a bluish or greenish tint for 24-48 hours after a dose. It's harmless.

**Blue staining of the mouth and tongue.** If you take it in liquid form or open capsules, your mouth will turn blue. Capsules minimize this, but some staining may still occur.

**Blue-tinged sweat.** Some people notice faint blue staining on white clothing from sweat. This is rare at low doses.

### Actual Side Effects

**GI upset.** Nausea, stomach cramps, or diarrhea can occur, especially on an empty stomach or at higher doses. Taking it with food usually helps.

**Headache.** Some users report headaches, particularly when starting. This may relate to the nitric oxide modulation effects.

**Dizziness.** Usually transient and dose-related.

**Elevated blood pressure.** Due to NO inhibition, methylene blue can raise blood pressure slightly. People with hypertension should monitor their BP.
...
- **Medications metabolized by CYP enzymes.** Methylene blue can affect several cytochrome P450 enzymes, potentially altering the metabolism of other drugs.
- **Photosensitizing drugs.** Methylene blue increases photosensitivity. Combining it with other photosensitizing medications (tetracyclines, fluoroquinolones) increases sunburn risk.
...
Many people do take it daily at low doses (0.5-1 mg/kg) without apparent issues. Some prefer cycling (5 days on, 2 off, or 3 weeks on, 1 week off) based on the general principle of avoiding tolerance. There isn't strong evidence for or against daily use at nootropic doses.
...
There's no significant known interaction between methylene blue and caffeine. Many users combine them without issues. Both can raise blood pressure slightly, so people with hypertension should be aware of the cumulative effect.

### What's the best time of day to take methylene blue?

Morning is generally recommended. Methylene blue can be mildly energizing due to the mitochondrial effects, and some users report insomnia if they take it in the afternoon or evening. Taking it with breakfast is a common approach.
...
Many users report noticeable cognitive effects within 30-60 minutes of the first dose. The mitochondrial effects are rapid because methylene blue is acting directly on the electron transport chain. Longer-term benefits like potential neuroprotection and anti-aging effects obviously take much longer and aren't subjectively noticeable.
