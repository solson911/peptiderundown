...
> **Key Takeaways**
> - Reconstitution means dissolving freeze-dried peptide powder in bacteriostatic water
> - Always use bacteriostatic water (not plain sterile water) for multi-use vials
> - Add water slowly along the vial wall, never directly onto the powder
> - Never shake the vial; gentle swirling only
> - Reconstituted peptides last 3-4 weeks refrigerated
> - The dose formula: Units to draw = (Dose in mg / Concentration in mg/mL) x 100
...
- **Syringe filter (0.22μm)** : For extra filtration if desired
- **Sharps container**, for safe needle disposal
- **Gloves**, nitrile, for keeping things clean
- **Clean workspace**, a wiped-down table or counter is fine
...
Alright, let's do this. Take your time; there's no rush.
...
- **5mg vial + 1mL BAC water** = 5 mg/mL
...
- You can also gently **swirl** the vial in small circles.
- **Never shake the vial.** Shaking creates foam and can denature (damage) the peptide.

The solution should be **clear** when fully dissolved. If it's cloudy or has visible particles after 10 minutes of gentle swirling, something may be wrong. Don't use it.
...
> **Skip the math?** Use our free <a href="/articles/peptide-dosing-calculator-reconstitution-math">Peptide Reconstitution Calculator</a>. Plug in your vial size, water volume, and desired dose  -  it tells you exactly <a href="/articles/peptide-dosing-calculator-reconstitution-math">how many units to draw</a>. No math required.
...
That's it. Let's run through some examples.
...
If your dose is 250mcg (0.25mg), you need:
- 0.25mg ÷ 2.5mg/mL = 0.1mL = **10 units** on an insulin syringe

### Example 2: Larger Vial

- **Vial:** 10mg of peptide
- **Water added:** 2mL of BAC water
- **Concentration:** 10mg ÷ 2mL = **5 mg/mL**

If your dose is 500mcg (0.5mg):
- 0.5mg ÷ 5mg/mL = 0.1mL = **10 units** on an insulin syringe

### Example 3: More Water for Easier Measurement

- **Vial:** 5mg of peptide
- **Water added:** 2.5mL of BAC water
- **Concentration:** 5mg ÷ 2.5mL = **2 mg/mL**

If your dose is 100mcg (0.1mg):
- 0.1mg ÷ 2mg/mL = 0.05mL = **5 units** on an insulin syringe

### Understanding Insulin Syringe Units

A standard **1mL insulin syringe** has **100 units** total. Each unit = 0.01mL. So:
...
Or if you prefer working in micrograms:
...
- **Refrigerate immediately** after reconstitution. Store at **36–46°F (2–8°C)**. Your standard refrigerator is perfect.
- **Keep the vial upright** to minimize contact between the solution and the rubber stopper.
- **Protect from light.** Keep the vial in its box or wrap it in foil. Light degrades many peptides.
- **Don't freeze** reconstituted peptides. Freezing can damage the molecular structure.
- **Shelf life:** Most reconstituted peptides (in BAC water) remain stable for **21–28 days** when refrigerated. Some hardier peptides may last longer, but 3–4 weeks is a safe general guideline.

### Unreconstituted Storage

If you haven't mixed your peptide yet:

- **Room temperature:** Most lyophilized peptides are stable for weeks to months.
...
Learning from other people's mistakes is the best kind of learning. Here are the most common ones:

### 1. Shooting Water Directly onto the Powder
We covered this, but it's worth repeating. Aim for the vial wall, let the water trickle down. Direct force can damage the peptide.

### 2. Shaking the Vial
Shaking creates bubbles and can denature the peptide. Gentle rolling or swirling only. Patience is your friend.

### 3. Using the Wrong Solvent
Bacteriostatic water is standard for most peptides. Some peptides require specific solvents like acetic acid or DMSO. Always check the documentation for your specific peptide before reconstituting.

### 4. Not Sterilizing Vial Tops
...
### 5. Reusing Needles
Needles dull after a single use. A dull needle causes more tissue damage and increases infection risk. Insulin syringes are inexpensive, so use a fresh one each time.

### 6. Leaving Reconstituted Peptides at Room Temperature
Reconstituted peptides degrade rapidly at room temperature. Get them back in the fridge as soon as you've drawn your dose.

### 7. Math Errors on Dosing
Double-check your concentration calculation and your dose calculation every time, especially when starting out. Getting the decimal in the wrong place means a 10x dosing error.
...
Reconstituted peptides need to stay refrigerated. For short trips, an insulated bag with ice packs can work. For longer travel, consider bringing unreconstituted vials and BAC water separately, and reconstituting at your destination.

### What size syringe should I use for reconstitution vs. dosing?

- **Reconstitution:** Use a **1–3mL syringe** with a standard needle (25–27 gauge). The larger barrel makes it easier to measure 1–2mL of water.
- **Dosing:** Use a **1mL (100 unit) insulin syringe** with a 29–31 gauge needle. The fine markings allow precise dose measurement, and the thin needle minimizes discomfort.
...
Yes. If you realize your concentration is too high and you want to dilute it further, you can add more BAC water. Just recalculate your new concentration using the total volume of water. For example: 5mg vial + initial 1mL + additional 1mL = 5mg in 2mL = 2.5mg/mL.

### My peptide powder looks like it collapsed or moved in the vial. Is it still good?
...
And if you don't want to do the dosage math by hand, bookmark our free <a href="/articles/peptide-dosing-calculator-reconstitution-math">Peptide Reconstitution Calculator</a>. It handles all the calculations instantly.
